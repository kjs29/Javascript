...
4. Create javascript file to test, and test file.
    ...
    There are many ways to find out about `chai`'s syntax. [Chai Documentation](https://www.chaijs.com/api/bdd/)
    ...
    Inside this `it()` function, we created a new instance of `Person()` class.
